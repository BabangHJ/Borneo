...
function changeImage(step) {
  ...
  imgContents.forEach((imgContent) => {
    ...
    currentIndex = parseInt(span.innerText) - 1;
    currentIndex = (currentIndex + step + imgContents.length) % imgContents.length;
    console.log(currentIndex);
    
    // pertama: 2-1 = 1, 9 % 8 = 1 + 1 = 2
    // kedua: 3-1 = 2, 10 % 8 = 2+1 = 3
    // ketiga = 4-1 = 3, 11 % 8 = 3 + 1 = 4
    // keempat = 5-1 = 4 , 12 % 8 = 4 + 1 = 5
...
less.addEventListener("click", function () {
  ...
  if (isExpanded) {
    ...
    imgContents.forEach((imgContent) => {
      ...
      const imgSmall = imgContent.querySelector(".img-dlm img");
      const paragraph = imgContent.querySelector(".image-cont-first span");
      const span = imgContent.querySelector(".p-1");
      lastIndex = (lastIndex + imgContents.length) % imgContents.length;
      imgSmall.src = getImagePath(lastIndex);
      paragraph.innerText = getTitle(lastIndex);
      span.innerText = lastIndex+1;
...
function changeImage2(step2) {
  ...
  imgContents2.forEach((imgContent2) => {
    ...
    currentIndex2 = parseInt(span2.innerText) - 1;
    currentIndex2 =
...
all2.addEventListener("click", function () {
  ...
  imgContents2.forEach((imgContent2) => {
    ...
    imgContent2.addEventListener("click", function () {
      const currentIndex2 = parseInt(imgContent2.querySelector("p").innerText) - 1;
      imgBig2.src = getImagePath2(currentIndex2);
      lastIndex2 = currentIndex2-1;
      // paragraph2.innerText = getTitle2(currentIndex2);
...
less2.addEventListener("click", function () {
  ...
  if (isExpanded2) {
    ...
    imgContents2.forEach((imgContent) => {
      ...
      const imgSmall2 = imgContent.querySelector(".img-dlm-2 img");
      const paragraph2 = imgContent.querySelector(".image-cont-first-2 span");
      const span2 = imgContent.querySelector(".p-2");
      lastIndex2 = (lastIndex2 + imgContents2.length) % imgContents2.length;
      imgSmall2.src = getImagePath2(lastIndex2);
      paragraph2.innerText = getTitle2(lastIndex2);
      span2.innerText = lastIndex2+1;
      lastIndex2+=1;
    });
...
function changeImage3(step) {
  ...
  imgContents3.forEach((imgContent) => {
    ...
    currentIndex3 = parseInt(span3.innerText) - 1;
...
less3.addEventListener("click", function () {
  ...
  if (isExpanded3) {
    ...
    imgContents3.forEach((imgContent3) => {
      ...
      const imgSmall3 = imgContent3.querySelector(".img-dlm-3 img");
      const paragraph3 = imgContent3.querySelector(".image-cont-first-3 span");
      const span3 = imgContent3.querySelector(".p-3");
      lastIndex3 = (lastindex3 + imgContents3.length) % imgContents3.length;
      imgSmall3.src = getImagePath3(lastIndex3);
      paragraph3.innerText = getTitle3(lastIndex3);
      span3.innerText = lastindex3+1;
      lastindex3+=1;
    });
...
/*
1. buat database penampung isi data makanan,wayang,games yang dapat diakses langsung ke page learn more.
2. if title besar === bubur pedas maka ke page learn more dan halamannya berisikan data bubur pedas
yang diambil dari database.

*/


// const Exploretitle = document.getElementById("TitleExploreFirst");
const LearnMore = document.getElementById("LinkExploreFirst");
const Exploretitle = document.getElementById("TitleExploreFirst");

LearnMore.addEventListener("click", function () {
    localStorage.setItem("exploreTitle", Exploretitle.textContent);
